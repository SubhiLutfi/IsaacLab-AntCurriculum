...
"""Stage 1: Straight corridor locomotion.

Adds two parallel walls to constrain the ant to a corridor.
Observation space identical to Stage 0 (scan still dummy).
"""
...
@configclass
class AntStage1CorridorEnvCfg(ManagerBasedRLEnvCfg):
    """Stage 1: corridor locomotion, loading from Stage 0 checkpoint."""
