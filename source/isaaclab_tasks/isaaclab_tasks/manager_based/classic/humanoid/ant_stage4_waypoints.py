...
"""Stage 4: Corridor with one chicane + waypoint navigation.

Activates live waypoint observations (angle, heading, distance).
base_angle_to_target and base_heading_proj now point to the current
waypoint instead of (1000, 0, 0) — observation dimension stays FIXED.
progress reward replaced with waypoint_progress_reward.
"""
...
WAYPOINTS = ((5.0, 1.5, 0.0), (6.5, 6.5, 0.0))
REACH_RADIUS = 1.0
...
@configclass
class AntStage4WaypointsEnvCfg(ManagerBasedRLEnvCfg):
    """Stage 4: corridor + chicane with live waypoint navigation."""
